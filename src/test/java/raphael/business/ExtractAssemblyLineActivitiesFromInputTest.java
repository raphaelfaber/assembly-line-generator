...
public class ExtractAssemblyLineActivitiesFromInputTest extends TestCase {
    public void testIfExtractionFromOneLineCoherent(){
        ...
        AssemblyLineActivity expected = new AssemblyLineActivity(10,"Cutting wood to feed heat machine");
        ...
        AssemblyLineActivity expected2 = new AssemblyLineActivity(10,"Cutting wood to feed heat machine");
        AssemblyLineActivity tested2 = ExtractAssemblyLineActivitiesFromInput.extractActivityFromOneLine(lineTest);
